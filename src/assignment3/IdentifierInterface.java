...
public interface IdentifierInterface<E> extends Data<E> {
     ...
     * 		c must be a letter;
     * @postcondition
     * 		Existing characters replaced with c;
     */
     ...
     * @precondition
     *	    The first character of name must be a letter AND length > 0 AND all characters must be alphanumeric.
     * @postcondition
     *	    The identifier is replaced with name.
     **/
     ...
     * @postcondition
     * 		c is added to the end of the Identifier.
     */
    void addChar(char c);

    /** Returns the character at the given position.
     * @precondition
     * 		The position must be > 0 AND <= length of the Identifier.
     * @postcondition
     ...
     * 		-
     * @postcondition
     * 		Length of the identifier is returned.
     */
    int length();
     ...
     * @precondition
     *      The specified identifier must not be null. //todo AskMike can it be Null??
     * @postcondition
     * 		Returns the string value of the identifier
     */
    String toString();
