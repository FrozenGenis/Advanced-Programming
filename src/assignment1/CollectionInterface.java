...
public interface CollectionInterface {
     ...
     *           -
     *		@postcondition
     *           The new Collection-object contains a copy of the src.
     **/
     ...
     * @precondition
     *	    The collection must not have more than 20 elements.
     * @postcondition
     *	    The element is in the collection.
     **/
     ...
     *	    -
     * @postcondition
     *	    TRUE: the number of elements in the collection == 0.
     ...
     *	    -
     * @postcondition
     *	    The amount of elements of the collection is returned.
     **/
    int size ();
     ...
     * @postcondition
     *	    the string of all the identifiers in the collection separated by spaces
     **/
    String toString();
     ...
     *	    -
     * @postcondition
     *	    Collection-object returned containing identifiers which are present in the collection but absent in the parameter.
     **/
     ...
     *	    -
     * @postcondition
     *	    Collection-object returned containing identifiers which are present in both the collection and parameter.
     **/
     ...
     * @throws
     *	    Exception if the new Collection-object exceeds 20 elements.
     * @postcondition
     *	    Collection-object returned containing all distinct identifiers from the collection and parameter.
     **/
     ...
     *	    -
     * @postcondition
     *	    Collection-object returned containing identifiers which are present in the collection but not in the parameter
     *      and identifiers which are present in the parameter but not in the collection.
     **/
