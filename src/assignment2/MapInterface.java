...
public interface MapInterface<K extends Data<K>, V extends Clonable<V>> {
     ...
     * @precondition
     *	    The map must contain the key.
     * @postcondition
     *	    The key and its corresponding value are no longer in the map.
     **/
    void remove(K key);
     ...
     *	    -
     * @postcondition
     *	    TRUE: the number of key:value pairs in the map == 0.
