...
public interface SetInterface<E extends Data<E>> extends Clonable<Set<E>> {
	 ...
	 *
	 * @precondition    -
	 * @postcondition   The element is no longer in the set.
	 **/
	 ...
	 * @postcondition   An element is returned and removed from the set.
	 **/
	E get();
	 ...
	 *
	 * @precondition    -
	 * @postcondition   TRUE: the number of elements in the set == 0.
	 ...
	 *
	 * @precondition    -
	 * @postcondition   Size of the set is returned.
	 */
	int size();
	 ...
	 *
	 * @precondition    -
	 * @postcondition   TRUE: the element is in the set.
	 ...
	 *
	 * @precondition    -
	 * @postcondition   A string of all the elements of the list is returned.
	 */
	String toString();
	 ...
	 *
	 * @precondition    -
	 * @postcondition   A new Set-object is returned containing all the distinct elements from the set and the parameter.
	 */
	 ...
	 *
	 * @precondition    -
	 * @postcondition   A new Set-object is returned containing all the elements which are present in both the set and parameter.
	 */
	 ...
	 *
	 * @precondition    -
	 * @postcondition   A new Set-object is returned containing all the elements which are present in the parameter but absent in the set.
	 */
	 ...
	 *
	 * @precondition    -
	 * @postcondition   A new Set-object is returned containing all elements which are present in the set but not in the parameter
	 *                  and elements which are present in the parameter but not in the set.
	 */
