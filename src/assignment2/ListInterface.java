...
public interface ListInterface<E extends Data<E>> extends Clonable<List<E>> {
	...
	/**
	 * @precondition    -
	 * @postcondition   list-POST is empty and is returned.
	 **/
	...
	/**
	 * @precondition    -
	 * @postcondition   FALSE: list is empty or current points to first element
